package com.sanjaybhat.filmrecommend.wear.network
...
object SupabaseClient {
     ...
     * Throws on any network or parsing failure so callers can handle the error.
     */
     ...
     * Throws on any network or parsing failure.
     */
    fun getRecommendations(title: String): List<Recommendation> {
        ...
        try {
            ...
            for (i in 0 until arr.length()) {
                ...
                // Skip entries without a poster — watch UI relies on poster images
